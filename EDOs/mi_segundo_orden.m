...
%Cambio de variables: y(t) = y1 y reemplazo x(t) por la señal de entrada, por ej u(t)
% y1'' = -c/a*y1 - b/a*y1' + d/a*u(t)
...
D = 3;  J = 1;  K = 2;  % Constantes de mi EDO

dy = [0 1; -K/J -D/J] * y + [0; 1/J] .*ft;
